...
## Saliency generation:
Download the repository from https://github.com/csmslab/proto-object-saliency-texture (Uejima et. al, 2020). Run runProtoObject.m after specifying the path towards the downloaded saliency generation folder on line 7. Specify input and output folders that are noted in the runProtoObject.m file, on line 14 and 16 respectively, and specify folder for runtime statistics on line 88, before running the matlab file on each dataset.
